...
void MX_TIM3_Init(void)
{
  ...
  htim3.Init.Period = (100000000/500000)-1;
...
void MX_TIM13_Init(void)
{
  ...
  htim13.Init.Period = (100000000 / 500000) - 1;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PB0     ------> TIM3_CH3
    */
    GPIO_InitStruct.Pin = MIOSTIM_1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(MIOSTIM_1_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = MIOSTIM_2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(MIOSTIM_2_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM4_MspPostInit 0 */
    ...
    PB9     ------> TIM4_CH4
    */
    GPIO_InitStruct.Pin = PUMP_PWM_Pin|PUMP_RES1_Pin|PUMP_RES2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM5_MspPostInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = COIL_RES1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM5;
    HAL_GPIO_Init(COIL_RES1_GPIO_Port, &GPIO_InitStruct);
